...
namespace Code.Movement
{
    public class SpiderMovement : MonoBehaviour
    {
        ...
        void HandleGravity()
        {
            ...
            {
                _rb.AddForce(-_surfaceNormal * (gravityMultiplier * 4f), ForceMode.Acceleration);
            }
            else
            {
        ...
        void HandleJump()
        {
            if (Input.GetKeyDown(KeyCode.Space) && _canJump)
            {
                ...
                {
                    jumpDirection = (_surfaceNormal * 0.5f + cameraTransform.forward * 0.5f).normalized;
                    _targetNormal = Vector3.up;
                    _isClimbing = false;
                ...
                {
                    jumpDirection = (_surfaceNormal * 0.5f + transform.forward * 0.5f).normalized;
                }
